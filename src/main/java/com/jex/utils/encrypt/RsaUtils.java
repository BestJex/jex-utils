...
public class RsaUtils {
	...
	public static String sign(byte[] data, String privateKey) throws GeneralSecurityException {
		byte[] keyBytes = Base64Utils.decryptBytes(privateKey);
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws GeneralSecurityException {
		byte[] keyBytes = Base64Utils.decryptBytes(publicKey);
		...
		signature.update(data);
		return signature.verify(Base64Utils.decryptBytes(sign));
	}
	...
	public static String getPrivateKey2CSharp(Map<String, Object> keyMap) throws GeneralSecurityException {
		...
		sb.append("<Modulus>" + Base64Utils.encrypt(removeMSZero(privateK.getModulus().toByteArray())) + "</Modulus>");
		sb.append("<Exponent>" + Base64Utils.encrypt(removeMSZero(privateK.getPublicExponent().toByteArray())) + "</Exponent>");
		sb.append("<P>" + Base64Utils.encrypt(removeMSZero(privateK.getPrimeP().toByteArray())) + "</P>");
		sb.append("<Q>" + Base64Utils.encrypt(removeMSZero(privateK.getPrimeQ().toByteArray())) + "</Q>");
		sb.append("<DP>" + Base64Utils.encrypt(removeMSZero(privateK.getPrimeExponentP().toByteArray())) + "</DP>");
		sb.append("<DQ>" + Base64Utils.encrypt(removeMSZero(privateK.getPrimeExponentQ().toByteArray())) + "</DQ>");
		sb.append("<InverseQ>" + Base64Utils.encrypt(removeMSZero(privateK.getCrtCoefficient().toByteArray())) + "</InverseQ>");
		sb.append("<D>" + Base64Utils.encrypt(removeMSZero(privateK.getPrivateExponent().toByteArray())) + "</D>");
		sb.append("</RSAKeyValue>");
		return sb.toString();
	}
	...
	public static String getPublicKey2CSharp(Map<String, Object> keyMap) throws GeneralSecurityException {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("<RSAKeyValue>");
		sb.append("<Modulus>" + Base64Utils.encrypt(removeMSZero(publicK.getModulus().toByteArray())) + "</Modulus>");
		sb.append("<Exponent>" + Base64Utils.encrypt(removeMSZero(publicK.getPublicExponent().toByteArray())) + "</Exponent>");
		sb.append("</RSAKeyValue>");
		return sb.toString();
	}
	...
	static void testPublicEncryptPrivateDecrypt() {
		...
		try {
			...
			String base64 = Base64Utils.encrypt(encryptedData);
			System.out.println(base64 + "\r\n===============");
			byte[] decryptedData = RsaUtils.decryptByPrivateKey(Base64Utils.decryptBytes(base64), RsaUtils.getPrivateKey(keyMap));
	...
	static void testPrivateEncryptPublicDecrypt() {
		...
		try {
			...
			System.out.println(Base64Utils.encrypt(encryptedData) + "\r\n===============");
