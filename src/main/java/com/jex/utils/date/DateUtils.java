package com.jex.utils.date;

import com.jex.utils.base.StringUtils;
...
public class DateUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(dateParse("2019-08-31 14:58:20", null));
		...
		//System.out.println(dateBetween(dateParse("2017-01-30", null), dateParse("2019-08-31", null)));
		//System.out.println(dateBetweenIncludeToday(dateParse("2019-08-31", null), dateParse("2017-02-01", null)));
		System.out.println(getDate(dateParse("2019-08-31", null)));
		/*
		System.out.println(getDaysOfMonth(dateParse("2019-08-21", null)));
		System.out.println(getDaysOfYear(dateParse("2019-08-31", null)));*/
		//System.out.println(dateFormat(dateAddMonths(dateParse("2019-08-31", StrUtils.MONTH_PATTERN), -12), StrUtils.MONTH_PATTERN));
		/*System.out.println(dateFormat(maxDateOfMonth(dateParse("2019-08", "yyyy-MM")), null));
		System.out.println(dateFormat(minDateOfMonth(dateParse("2019-08-31", null)), null));*/
	}
